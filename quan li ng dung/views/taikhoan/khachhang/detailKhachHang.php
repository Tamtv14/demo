        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <img src="<?= BASE_URL . $khachHang['anh_dai_dien'] ?>" 
                        width="70%" alt=""
                        onerror="this.onerror=null; this.src='https: //img6.thuthuatphanmem.vn/uploads/2022/01/27/R.png'">
...
<tbody>
  <?php foreach ($listBinhLuan as $key => $binhLuan) : ?>
    <tr>
      ...
      <!-- <td><span class="badge text-gb-primary"></span></td> -->
      <td>
        <form action="<?= BASE_URL_ADMIN . '?act=update-trang-thai-binh-luan&id_binh_luan=' . $binhLuan['id'] ?>" method="POST">
